const CACHE_NAME='attack-profiler-pwa-v7-cti-triage';
const APP_SHELL=['./','./index.html','./styles.css','./cti.css','./app.js','./cti.js','./manifest.json','./manifest.webmanifest','./icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
